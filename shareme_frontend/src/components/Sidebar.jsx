...
const isActiveStyle = 'flex items-center px-5 gap-3 font-extrabold border-r-2 border-black'
	...
	return (
		...
		h-full overflow-y-scrikk min-w-210 hide-scrollbar">
		<div className="flex flex-col" onClick={handleCloseSidebar}>
		<Link to="/" className="flex px-5 gap-2 my-6 
		pt-1 w-190 items-center">
...
<img src={category.image} className="w-8 h-8 rounded-full shadow-sm" alt="category"/>
...

		{
			user && (
				...
				items-center bg-white rounded-lg shadow-lg mx-3">
